...
public class Login extends javax.swing.JFrame {
    ...
    private void userLogin(){
        try{
           ...
           pst.setString(3, String.valueOf(comboType.getSelectedItem()));
           ResultSet rs=pst.executeQuery();
           
           if(rs.next()) {
             JOptionPane.showMessageDialog(this, "Loging Information Matched","Login Proceed", JOptionPane.INFORMATION_MESSAGE);  
        ...
        JOptionPane.showMessageDialog(null, "Username, Password or User Type not Matched","Login Denied", JOptionPane.INFORMATION_MESSAGE);
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(comboType, 0, 170, Short.MAX_VALUE)
