...
public class reportDelivery extends javax.swing.JFrame {
  ...
  private void showDelivery(){
        ...
        try{
            ...
            String sql = "select dv_PCode, dv_PName, dv_Qty, dv_Cat,  dv_Session, dv_Date from delivery ";
            ...
            tm.setRowCount(0);
            while(rs.next()){
            Object o[]={rs.getString("dv_PCode"), rs.getString("dv_PName"), rs.getString("dv_Qty"), 
                rs.getString("dv_Cat"), rs.getString("dv_Session"),rs.getString("dv_Date") };
            tm.addRow(o);
            } 
            con.close();
        }
  ...
  private void searchbySessionCode(){
        ...
        try{
            dbConnection db = new dbConnection();     
            Connection con=db.getConnection(); 
            String sql = "select dv_PCode, dv_PName, dv_Qty, dv_Cat,  dv_Session, dv_Date from delivery where dv_PCode = '"+search+"' OR  dv_Session = '"+search+"' OR dv_PName = '"+search+"' OR dv_Cat = '"+search+"' ";
            PreparedStatement pst = con.prepareStatement(sql);
            ResultSet rs = pst.executeQuery();
      ...
      private void showDeliveryDate(){
        ...
        try{
            dbConnection db = new dbConnection();     
            Connection con=db.getConnection(); 
            String sql = "select dv_PCode, dv_PName, dv_Qty, dv_Cat,  dv_Session, dv_Date from delivery WHERE dv_Date  BETWEEN '"+date1+"' AND '"+date2+"' ";
            PreparedStatement pst = con.prepareStatement(sql);
            ResultSet rs = pst.executeQuery();
    ...
    private void initComponents() {
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Delivery Records", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(0, 255, 204))); // NOI18N
        ...
        tblShowDelivery.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Code", "Product Name", "Quantity", "Type", "Session", "Date"
            }
        ));
        ...
        jLabel2.setText("View Delivery Records");
        ...
        txtSearch.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Search Based on Code or Name or Session or Type", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new reportDelivery().setVisible(true);
            }
        });
    }
